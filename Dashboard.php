...
<body>
    <main class="dashboard">
        <h1>SELAMAT DATANG DI FORM PENGADUAN MASYARAKAT</h1>
        <p>Jangan ragu untuk melaporkan. Data anda aman di kami</p>
        <a href="./view_pelapor/index.php" class="laporkan">Laporkan</a>
      </main>
